                        ...
                        helpers.extend(
                            ...
                            /** @lends Chart.Controller */ {
                                ...
                                destroy: function () {
                                    ...
                                    if (
                                        me.chart.originalDevicePixelRatio !==
                                        undefined
                                    ) {
                                        me.chart.ctx.scale(
                                            1 /
                                    ...
                                    canvas.style.width =
                                        me.chart.originalCanvasStyleWidth;
                                    canvas.style.height =
                                        me.chart.originalCanvasStyleHeight;
                ...
                function (require, module, exports) {
                    ...
                    module.exports = function (Chart) {
                        ...
                        helpers.removeResizeListener = function (node) {
                            ...
                            if (hiddenIframe) {
                                hiddenIframe.parentNode.removeChild(
                                    hiddenIframe
                                );
                            }
                        };
                    ...
                    module.exports = function () {
                        ...
                        var Chart = function (context, config) {
                            ...
                            me.width =
                                ...
                                parseInt(
                                    helpers.getStyle(context.canvas, "width"),
                                    10
                                ) ||
                            ...
                            me.height =
                                ...
                                parseInt(
                                    helpers.getStyle(context.canvas, "height"),
                                    10
                                ) ||
                            ...
                            if (
                                isNaN(me.aspectRatio) ||
                                isFinite(me.aspectRatio) === false
                            ) {
                            ...
                            helpers.addResizeListener(
                                ...
                                function () {
                                    if (
                                        me.controller &&
                                        me.controller.config.options.responsive
                                    ) {
                    ...
                    module.exports = function (Chart) {
                        ...
                        Chart.Legend = Chart.Element.extend({
                            ...
                            buildLabels: function () {
                                var me = this;
                                me.legendItems =
                                    me.options.labels.generateLabels.call(
                                        me,
                                        me.chart
                                    );
                        ...
                        Chart.plugins = {
                            ...
                            notify: function (extension, args) {
                                ...
                                for (i = 0; i < ilen; ++i) {
                                    plugin = plugins[i];
                                    if (
                                        typeof plugin[extension] === "function"
                                    ) {
                                        if (
                    ...
                    module.exports = function (Chart) {
                        ...
                        Chart.Scale = Chart.Element.extend({
                            ...
                            convertTicksToLabels: function () {
                                ...
                                me.ticks = me.ticks.map(function (
                                    numericalTick,
                                    index,
                                    ticks
                                ) {
                                    ...
                                    return me.options.ticks.callback(
                                        numericalTick,
                                        index,
                                        ticks
                                    );
                    ...
                    module.exports = function (Chart) {
                        ...
                        Chart.Tooltip = Chart.Element.extend({
                            ...
                            update: function (changed) {
                                ...
                                if (active.length) {
                                    ...
                                    helpers.extend(model, {
                                        ...
                                        beforeBody: me.getBeforeBody(
                                            tooltipItems,
                                            data
                                        ),
                                        body: me.getBody(tooltipItems, data),
                                        afterBody: me.getAfterBody(
                                            tooltipItems,
                                            data
                                        ),
                                        footer: me.getFooter(
                            ...
                            getTooltipSize: function (vm) {
                                ...
                                size.height +=
                                    (titleLineCount - 1) * vm.titleSpacing; // Title Line Spacing
                                size.height += titleLineCount
                                    ? vm.titleMarginBottom
                                    : 0; // Title's bottom Margin
                                size.height +=
                                    combinedBodyLength * bodyFontSize; // Body Lines
                                ...
                                widthPadding =
                                    body.length > 1 ? bodyFontSize + 2 : 0;
                            ...
                            drawTitle: function (pt, vm, ctx, opacity) {
                                ...
                                if (title.length) {
                                    ...
                                    var titleFontColor = helpers.color(
                                        vm.titleFontColor
                                    );
                            ...
                            drawBody: function (pt, vm, ctx, opacity) {
                                ...
                                var bodyFontColor = helpers.color(
                                    vm.bodyFontColor
                                );
                            ...
                            drawFooter: function (pt, vm, ctx, opacity) {
                                ...
                                if (footer.length) {
                                    ...
                                    var footerFontColor = helpers.color(
                                        vm.footerFontColor
                                    );
                                    ctx.fillStyle = footerFontColor
                                        .alpha(
                                            opacity * footerFontColor.alpha()
                                        )
                                        .rgbString();
                                    ctx.font = helpers.fontString(
                                        vm.footerFontSize,
                        ...
                        var LinearScale = Chart.LinearScaleBase.extend({
                            ...
                            getValueForPixel: function (pixel) {
                                ...
                                var innerDimension = isHorizontal
                                    ...
                                    : me.height -
                                      (me.paddingTop + paddingBottom);
                                var offset =
                                    (isHorizontal
                                        ? pixel - me.left - paddingLeft
                                        : me.bottom - paddingBottom - pixel) /
                                    innerDimension;
                    ...
                    module.exports = function (Chart) {
                        ...
                        Chart.LinearScaleBase = Chart.Scale.extend({
                            ...
                            buildTicks: function () {
                                ...
                                var niceMin =
                                    Math.floor(me.min / spacing) * spacing;
                                var niceMax =
                                    Math.ceil(me.max / spacing) * spacing;
                        ...
                        var LinearRadialScale = Chart.LinearScaleBase.extend({
                            ...
                            fit: function () {
                                ...
                                for (i = 0; i < this.getValueCount(); i++) {
                                    ...
                                    var angleRadians =
                                        this.getIndexAngle(i) + Math.PI / 2;
                                    var angle =
                                        ((angleRadians * 360) / (2 * Math.PI)) %
                                        360;
                    ...
                    module.exports = function (Chart) {
                        ...
                        var TimeScale = Chart.Scale.extend({
                            ...
                            getLabelForIndex: function (index, datasetIndex) {
                                ...
                                if (
                                    typeof me.chart.data.datasets[datasetIndex]
                                        .data[0] === "object"
                                ) {
                            ...
                            getPixelForValue: function (
                                ...
                                if (offset !== null) {
                                    ...
                                    var innerHeight =
                                        ...
                                        (me.paddingTop + me.paddingBottom);
                                    var heightOffset =
                                        innerHeight * decimal + me.paddingTop;
